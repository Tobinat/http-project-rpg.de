/*
    ...
    Owner's name:
*/
class The_Programmer_Iphone_Settings_Menu_p2 {
   idd = 1500;
   name = "The_Programmer_Iphone_Settings_Menu_p2";
   movingenable = 1;
   enablesimulation = 1;
   ...
   class controlsBackground
   {
       ...
       {
           text = "The-Programmer\Iphone_X\textures\settings\parametre_complet_p2.paa";
           idc = 2000;
   ...
   class controls
   {
       ...
       class Fond_Ecran : Life_RscButtonInvisibleIphone
       {
           ...
           y = 0.571345785644051 * safezoneH + safezoneY;
           w = 0.175 * safezoneW;
           h = 0.04 * safezoneH;
           idc = -1;
