...
switch (_selected) do {
    case "0": {priceArrayOre = [65,45,75,10,115]; publicVariable "priceArrayOre"; ["Wirtschaft","Bergleute machen einen Streik, in Fabriken fehlt Bronze für die Produktion!",[255,192,203,1],""] remoteExec ["Client_fnc_showNotification", -2]; diag_log "SERVER: Economy Event wurde erfolgreich implementiert: Copper"; };
    case "1": {priceArrayOre = [30,75,75,10,115]; publicVariable "priceArrayOre"; ["Wirtschaft","Wissenschaftler haben herausgefunden, dass die Verfügbarkeit von Eisen fallen wird 10%!",[255,192,203,1],""] remoteExec ["Client_fnc_showNotification", -2]; diag_log "SERVER: Economy Event wurde erfolgreich implementiert: Iron";};
