...
switch (_selected) do {
    ...
    case "2": {priceArrayOre = [60,90,180,20,230,60,70,30,240]; publicVariable "priceArrayOre"; ["Wirtschaft","Schmuckhersteller kaufen große Mengen Silber!",[255,192,203,1],""] remoteExec ["Client_fnc_showNotification", -2];};
