...
[_player,objNull,24,format ["%1 ließ ein geschäft von der Polizei durchsuchen", name _player],""] call server_fnc_actionLog;
...
["Deine Kiste ist steht bereit, währenddessen kann dein Shop nicht genutzt werden.", false] remoteExec ["domsg",_player];

["Du kannst Preise ändern, sobald die Kiste wieder eingepackt wurde.", false] remoteExec ["domsg",_player];
...
if (isNil _shopname) then {
	_text = "Du hast dein Geschäft nicht benannt";
