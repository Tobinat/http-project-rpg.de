...
if (drugcount > 150) then {
    ...
    if (_roll > 50) then {
        ...
        if (_pos distance[8864.24, 7599.97, 0.00144005] < _pos distance[6926.55, 2117.05, 0.00143814]) then {
            ...
            if (_pos distance[8864.24, 7599.97, 0.00144005] < _pos distance[900.986, 7688.17, 0.00143814]) then {
                _vehspawn = [8864.24, 7599.97, 0.00144005];
            } else {
                _vehspawn = [900.986, 7688.17, 0.00143814];
            };
        } else {
            if (_pos distance[6926.55, 2117.05, 0.00143814] < _pos distance[900.986, 7688.17, 0.00143814]) then {
                _vehspawn = [6926.55, 2117.05, 0.00143814];
            } else {
                _vehspawn = [900.986, 7688.17, 0.00143814];
            };
