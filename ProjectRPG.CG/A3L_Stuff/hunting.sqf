...
fnc_gutanimal = {
	...
	if (!_iskilled) exitwith {["Das Tier ist nicht tot!",5,"red"] spawn domsg; life_action_inUse = false;};
	_animalname = "";
	_amountyouget = 0;
	_extraamount = 8;
	_itemyouget = "";
	...
	if (!([true,_itemyouget,_totalamount] call life_fnc_handleInv)) exitwith {["Du bist zu überfüllt!",5,"red"] spawn domsg; life_action_inUse = false;};
