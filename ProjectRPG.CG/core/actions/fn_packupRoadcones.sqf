...
{	
	...
	{
	["Du hast die Reihe mit blinkenden Hütchen zusammengepackt", false] spawn domsg;;
	...
	{
	["Du hast das blinkende Hütchen zusammengepackt", false] spawn domsg;
	{deleteVehicle _x} foreach _roadconesobjects;
	};
	};
};
	...
	{
	["Du hast die Reihe mit Hütchen zusammengepackt", false] spawn domsg;
	{deleteVehicle _x} foreach _roadconesobjects;
	};
	};
	if (count _roadconesobjects <= 1) then {
	...
	{
	["Du hast das Hütchen zusammengepackt", false] spawn domsg;
	{deleteVehicle _x} foreach _roadconesobjects;
	};
	};
};
