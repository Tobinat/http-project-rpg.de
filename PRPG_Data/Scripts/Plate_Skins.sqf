...
_this setObjectTexture [4, "\PRPG_Data\plates\-.paa"];
_this setObjectTexture [1, format ["\PRPG_Data\plates\%1.paa",_plate1]];
_this setObjectTexture [2, format ["\PRPG_Data\plates\%1.paa",_plate2]];
_this setObjectTexture [3, format ["\PRPG_Data\plates\%1.paa",_plate3]];
_this setObjectTexture [5, format ["\PRPG_Data\plates\%1.paa",_plate5]];
