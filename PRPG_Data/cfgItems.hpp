class kif_BrickStack: ItemCore {
	...
	picture="\PRPG_Data\textures\icons\items\Bricks.paa";
...
class kif_MetalStack: ItemCore {
	...
	descriptionShort="Hand these in at a Building Vendor!";
	picture="\PRPG_Data\textures\icons\items\Metal.paa";
...
class kif_Grinder: ItemCore {
	...
	picture="\PRPG_Data\textures\icons\items\Grinder.paa";
...
class kif_Pseudo: ItemCore {
	...
	picture="\PRPG_Data\textures\icons\items\container.paa";
...
class kif_GasCooker: ItemCore {
	...
	picture="\PRPG_Data\textures\icons\items\GasCooker.paa";
...
class kif_gopro: ItemCore {
	...
	picture="\PRPG_Data\textures\icons\items\gopro.paa";
	model="\PRPG_Data\models\gopro\gopro.p3d";
	allowedSlots[]={901,801,701};
	mass=15;
};
class kif_nitro: ItemCore {
	...
	picture="\PRPG_Data\textures\icons\items\nitro.paa";
...
class kif_panicbutton: ItemCore {
	...
	picture="\PRPG_Data\textures\icons\items\panicbutton.paa";
	model="\PRPG_Data\models\panicbutton\button.p3d";
	allowedSlots[]={901,801,701};
	mass=15;
};
class kif_speedbomb: ItemCore {
	...
	model="\PRPG_Data\models\dynamit\dynamit.p3d";
	allowedSlots[]={901};
	mass=15;
};
class kif_fish_oil: ItemCore {
	...
	displayName="Tran";
	author="Extermi111";
	picture="\PRPG_Data\textures\icons\items\fish_oil.paa";
	model="\PRPG_Data\models\fish_oil\fish_oil.p3d";
	allowedSlots[]={901};
	mass=15;
};
class kif_gold_bar: ItemCore {
	...
	//picture="\PRPG_Data\textures\icons\items\fish_oil.paa";
	model="\PRPG_Data\models\ore_bar\gold_bar.p3d";
	allowedSlots[]={901};
	mass=15;
};
...
class prpg_workbench_normal_kit: ItemCore {
	...
	descriptionShort="Werkbank";
	mass=5;
	model = "\plp_containers\StcCartons\plp_cts_CartonRottenBig.p3d";
	picture="\PRPG_Data\models\prpg_logo_crafting.paa";
};
class prpg_workbench_weapon_kit: ItemCore {
	scope=2;
...
class prpg_workbench_car_kit: ItemCore {
	scope=2;
...
class prpg_workbench_clothing_kit: ItemCore {
	scope=2;
