...
if (_uid != "76561198006225826" && _uid != "76561198130126033" && _uid != "76561198108525408") exitwith {
	hint format["UID: %1 %2 ist nicht für das K9 freigeschaltet!", _unit, _uid];
};
"Alsatian_Sandblack_F" createUnit [_tempPos, group player,"dog = this", 5.0, "private"];
_dogenable = true;
				_acts12 = player addAction ["<t color = '#3f2ec3'>*Schließe K-9 Menü*</t>", {life_dog_order = 99}];
				_acts6 = player addAction ["<t color = '#ffff00'>Folge mir!</t>", {life_dog_order = 1}];
				_acts1 = player addAction ["<t color = '#ffff00'>Komm zu mir!</t>", {life_dog_order = 6}];
				_acts14 = player addAction ["<t color = '#ffff00'>Durchschnüffel ihn</t>", {life_dog_order = 14}];
				_acts2 = player addAction ["<t color = '#ffff00'>Halt!</t>", {life_dog_order = 2}];
				_acts3 = player addAction ["<t color = '#ffff00'>Such die Gegend ab</t>", {life_dog_order = 3}];
				_acts7 = player addAction ["<t color = '#ffff00'>Such die Gegend ab und Fass!</t>", {life_dog_order = 7}];
				_acts8 = player addAction ["<t color = '#ffff00'>Zeig deine Zähne!</t>", {life_dog_order = 8}];
				_acts4 = player addAction ["<t color = '#ff0000'>Aus!</t>", {life_dog_order = 4}];
				_acts9 = player addAction ["<t color = '#ff0000'>Bellen 1</t>", {life_dog_order = 9}];
				_acts10 = player addAction ["<t color = '#ff0000'>Bellen 2</t>", {life_dog_order = 10}];
				_acts11 = player addAction ["<t color = '#ff0000'>Bellen 3</t>", {life_dog_order = 11}];
				_acts13 = player addAction ["<t color = '#3f2ec3'>*Öffne K-9 Menü*</t>", {life_dog_order = 98}];
hint format ["%1 - Komm her kleiner!",_dogname];
while { true } do {
uiSleep 0.05;
