...
//if(cash_in_hand < 5000) exitWith { ["You need $5000 dollars to create a permanent key.", false] spawn domsg; };
if(cash_in_hand < 5000) exitWith { ["Du brauchst $5000 dollar um einen permanenten Schlüssel zu erstellen zulassen.", false] spawn domsg; };
