...
*/
	...
	case "civ_air":
	{
		...
		[
			...
			["Sab_737_4",30000000],
			["Sab_737_5",30000000],
			["Sab_737_6",30000000], //#mcclaines arbeitzzzzzz
			["Sab_737_7",30000000],
			["Sab_af_An2",30000000],
			["Sab_tk_An2",30000000],
			["Sab_ca_An2",30000000],
			["Sab_ana_An2",30000000],
			["Sab_yel_An2",30000000],
			["Sab_fd_An2",30000000],
			...
			["IVORY_T6A_1",3000000],
			["bwi_a3_t6a",3000000],
            ["bwi_a3_t6a_1",3000000],
            ["bwi_a3_t6a_2",3000000],
            ["bwi_a3_t6a_3",3000000],
            ["bwi_a3_t6a_4",3000000],
            ["bwi_a3_t6a_5",3000000],
            ["bwi_a3_t6a_6",3000000],
			["bwi_a3_t6a_7",3000000],
            ["bwi_a3_t6a_8",3000000],
            ["bwi_a3_t6a_9",3000000],
            ["bwi_a3_t6c",3000000],
			["B_Heli_Light_01_F",3500000],
			["ivory_b206",3500000],
			["ivory_b206_news",4000000],
			["CUP_C_DC3_CIV",8000000],
