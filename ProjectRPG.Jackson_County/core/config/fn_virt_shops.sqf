...
switch (_shop) do
{
	...
	case "cop": {["Cop Item Shop",["coffee","donuts","medkit","panicbutton","bandage","fuelF","defusekit","RoadBlockWood","RoadCone","RoadConeStrip","RoadConeB","RoadConeStripB","tracker","Blaulicht"]]};
