...
player forceAddUniform "pRPG_Commander1";
...
["Sie besitzen nun die Grundausrüstung! Ey Commander, wie läufts im PD? Schau zu, dass da alles Rund läuft!", false] spawn doquickmsg;