...
switch (_className) do
{
	...
	case "cg_daf_xf_euro6_violet": {200};
	case "cg_daf_xf_euro6_rose": {200};
	case "cg_daf_xf_euro6_orange": {200};
	case "cg_daf_xf_euro6_grise": {200};
	case "cg_daf_xf_euro6_vert": {200};
	case "cg_daf_xf_euro6_bleufonce": {200};
	case "cg_daf_xf_euro6_bleu": {200};
	case "cg_daf_xf_euro6_white": {200};
	case "cg_daf_xf_euro6_jaune": {200};
	case "cg_daf_xf_euro6_rouge": {200};
	...
	case "cg_renault_magnum_truck_f_noir": {330};
	case "cg_renault_magnum_truck_f_violet": {330};
	case "cg_renault_magnum_truck_f_rose": {330};
	case "cg_renault_magnum_truck_f_orange": {330};
	case "cg_renault_magnum_truck_f_grise": {330};
	case "cg_renault_magnum_truck_f_vert": {330};
	case "cg_renault_magnum_truck_f_bleufonce": {330};
	case "cg_renault_magnum_truck_f_white": {330};
	case "cg_renault_magnum_truck_f_jaune": {330};
	case "cg_renault_magnum_truck_f_rouge": {330};



	case "shounka_ivceco_bleufonce": {390};
	case "shounka_ivceco_grise": {390};
	case "shounka_ivceco_jaune": {390};
	case "shounka_ivceco_noir": {390};
	case "shounka_ivceco_orange": {390};
	...
	case "shounka_rs6_noir": {50};
	case "shounka_rs6": {50};
	case "shounka_rs6_bleufonce": {50};
	case "shounka_rs6_rouge": {50};
	case "shounka_rs6_jaune": {50};
	case "shounka_rs6_rose": {50};
	case "shounka_rs6_grise": {50};
	case "shounka_rs6_violet": {50};
	case "shounka_rs6_orange": {50};
