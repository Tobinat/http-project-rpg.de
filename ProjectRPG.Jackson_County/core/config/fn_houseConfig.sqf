...
//	case (_house in ["Land_Pub_C"]): {[125000,1]};
	case (_house in ["Land_HouseA"]): {[4550000,3]};
	case (_house in ["Land_HouseA1_L"]): {[4550000,3]};
	case (_house in ["Land_HouseB"]): {[4550000,3]};
	case (_house in ["Land_HouseB1_L"]): {[4550000,3]};
	case (_house in ["Land_HouseC1_L"]): {[4550000,3]};
	case (_house in ["Land_HouseC_R"]): {[4550000,3]};
