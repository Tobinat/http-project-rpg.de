...
if ( (_curWep) != "CG_PICKAXE" ) exitwith { ["You need a pickaxe in your hands to farm this!", false] spawn domsg; harvesting = false; };
...
if(_chance > 1) exitwith { ["You failed to harvest anything!", false] spawn doquickmsg; harvesting = false;harvesting = false; };
