...
if(player getVariable["restrained",false] || player getVariable["tied",false]) exitWith {["How would you use a phone with your hands behind your back?", false] spawn domsg; closedialog 0;};
