...
if(isNull _curTarget) exitWith {hint "Ziel nicht verwendbar!"; closeDialog 0;}; //Bad target
if(!isPlayer _curTarget) exitWith {["Cannot perform this action!", false] spawn domsg; closeDialog 0;}; //Bad side check?
