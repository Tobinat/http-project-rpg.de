...
if((_vehicle isKindOf "Car") || !(_vehicle isKindOf "Air") || !(_vehicle isKindOf "Motorcycle") || !(_vehicle isKindOf "Motorbike") || !(_vehicle isKindOf "Ship")) then
{
	...
	{
		_owners = "Dieses Fahrzeug hat keinen Halter, Beschlagnahme es<br/>";
	};
	
	hint parsetext format["<img size='1' image='icons\info.paa'/> <t color='#FFCC00'><t size='0.75'>Vehicle Check:</t><br/> %1 ",_owners];
