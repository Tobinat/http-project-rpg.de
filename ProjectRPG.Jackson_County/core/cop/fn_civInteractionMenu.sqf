...
_Btn4 ctrlSetText "Fesseln lösen";
...
_Btn5 ctrlSetText "Sack überstülpen";
...
_Btn7 ctrlSetText "In Fahrzeug setzen";
...
_Btn8 ctrlSetText "Eskortieren";
_Btn8 buttonSetAction "[life_pInact_curTarget] call life_fnc_civescort; closeDialog 0;";
if ((_curTarget getVariable ["tied", false])) then {
} else {
_Btn8 ctrlEnable false;		
};

_Btn9 ctrlSetText "Loslassen";
_Btn9 buttonSetAction "[life_pInact_curTarget] call life_fnc_civstopescort; closeDialog 0;";
...
_Btn11 ctrlSetText "Knebel entfernen";
