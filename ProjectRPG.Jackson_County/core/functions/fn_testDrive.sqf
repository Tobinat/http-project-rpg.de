...
if(_isPassenger) then {
	...
	if(_spawnPoint isEqualTo "") exitWith {["Es gibt keine freien Plätze für eine Probefahrt.", false] spawn domsg};
	...
	["Ihre Probefahrt hat begonnen sie haben 5 Minuten Zeit um das Fahrzeug zu fahren und dann das Fahrzeug an den Händler zurückgegeben.", false] spawn domsg;
