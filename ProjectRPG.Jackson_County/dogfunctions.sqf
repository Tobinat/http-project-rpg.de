...
_acts6 = _unit addAction ["<t color = '#ffff00'>Folge mir!</t>", {life_dog_order = 1}];

_acts1 = _unit addAction ["<t color = '#ffff00'>Komm zu mir!</t>", {life_dog_order = 6}];

_acts2 = _unit addAction ["<t color = '#ffff00'>Halt!</t>", {life_dog_order = 2}];

_acts3 = _unit addAction ["<t color = '#ffff00'>Such die Gegend ab!</t>", {life_dog_order = 3}];

_acts7 = _unit addAction ["<t color = '#ffff00'>Such die Gegend ab und Fass!</t>", {life_dog_order = 7}];

_acts8 = _unit addAction ["<t color = '#ffff00'>Zeig deine Zähne!</t>", {life_dog_order = 8}];

_acts4 = _unit addAction ["<t color = '#ff0000'>Aus!</t>", {life_dog_order = 4}];

_acts9 = _unit addAction ["<t color = '#ff0000'>Bellen 1</t>", {life_dog_order = 9}];
_acts10 = _unit addAction ["<t color = '#ff0000'>Bellen 2</t>", {life_dog_order = 10}];
_acts11 = _unit addAction ["<t color = '#ff0000'>Bellen 3</t>", {life_dog_order = 11}];
