class MAV_ctrlMap: MAV_ctrlDefault
{
	...
	colorTrails[] =			{0.840,		0.760,		0.650,		0.150}; // Pedestrian trail border color
	colorTrailsFill[] =		{0.840,		0.760,		0.650,		0.650}; // Pedestrian trail color
	...
	//Parameters for drawing markers
	...
	//Line markers drawn by the player
	class LineMarker
	{
...
class MAV_ctrlMapEmpty: MAV_ctrlMap
{
