class MAV_ctrlCombo: MAV_ctrlDefaultText
{
	type = CT_COMBO; // Type
	...
	wholeHeight = 12 * SIZE_M * GRID_H; // Maximum height of expanded box (including the control height)
...
class MAV_ctrlComboToolbar: MAV_ctrlCombo
{
	colorBackground[] = {0.05,0.05,0.05,1}; // Fill color
	colorSelectBackground[] = {COLOR_ACTIVE_RGBA}; // Selected item fill color
