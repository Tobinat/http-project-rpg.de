class MAV_ctrlListbox: MAV_ctrlDefaultText
{
	...
	colorSelectBackground[] = {1,0.5,0,0.5}; // Selected item fill color
	colorSelectBackground2[] = {1,0.5,0,0.5}; // Selected item fill color (oscillates between this and colorSelectBackground)
	colorShadow[] = {0,0,0,0}; // Text shadow color (used only when shadow is 1)
