class MAV_ctrlListNBox: MAV_ctrlDefaultText
{
	...
	colorSelectBackground[] = {0.2, 0.2, 0.2, 0.75}; // Selected item fill color
	colorSelectBackground2[] = {0.2, 0.2, 0.2, 0.75}; // Selected item fill color (oscillates between this and colorSelectBackground)
