...
class RscDisplayTaxiCustomizeTaximeter {
	idd = MAV_IDD_RSCDISPLAYTAXICUSTOMIZETAXIMETER;
	onLoad = "['taxis\gui', 'RscDisplayTaxiCustomizeTaximeter', _this, 'RscDisplayTaxiCustomizeTaximeter'] call MAV_gui_fnc_initLayer";
	duration = 1e+030;
