...
_barArray = ["prpg_item_kupfer_bar","prpg_item_eisen_bar","prpg_item_silber_bar","NP_Wood","CG_OilCanister","prpg_item_aluminium_bar","prpg_item_blei_bar","prpg_item_glas"];
