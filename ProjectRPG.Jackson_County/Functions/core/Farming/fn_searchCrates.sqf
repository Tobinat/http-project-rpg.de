/*
	...
	Leute können Kisten durchsuchen und bekommen Random Loot.
*/
...
if (count currentCop < 2) exitWith {hint "Mindestens 2 Polizisten müssen im Dienst sein."; };
...
if (_chancelockpick > 850) then { player removeItem "cg_lockpick"; ["Dein Dietrich ist abgebrochen!", true] spawn domsg; };
...
if (_chanceloot > 400) then {
	...
	switch (_selected) do {
		...
		case "4": { for "_i" from 1 to 5 do { player addItem "prpg_item_silber_bar"; }; ["Du hast 5 Silber Barren gefunden!", true] spawn domsg; };
