...
if (_chors == 5) then {
     ...
     if("kif_fish_oil" in magazines player) then {
          ["Verabreiche Tran",10,client_fnc_healTimeTran,player,"AinvPknlMstpSnonWnonDnon_medic_1",[player,_myInjuries,10,"kif_fish_oil"],"prpg_data\sounds\patdown1.ogg"] spawn client_fnc_dotask; 
     } else { 
