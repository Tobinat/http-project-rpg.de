...
if(count(_prisonArray) > 0) then {
	...
	if(_houselevel == 1) then {
		_nObject = nearestObjects [_house, ["Land_ivory_trailer_04","Land_ivory_trailer_01","Land_ivory_trailer_02","Land_ivory_trailer_03","Land_ivory_trailer_06","Land_ivory_trailer_05"], 22200];
	...
	if(_houselevel == 4) then {
		_nObject = nearestObjects [_house, ["Land_Ranch_DED_Ranch_02_F","Land_Ranch_DED_Ranch_01_F","Land_HouseC_R","Land_HouseC1_L","Land_HouseA1_L","Land_HouseB1_L"], 22200];
	...
	if(_houselevel == 7) then {
		_nObject = nearestObjects [_house, ["Land_HouseDoubleAL","Land_HouseDoubleAL2"], 22200];
		_containerpos = (_nobject select 0) getrelpos [15,0];
		player setpos _containerpos;
	};
