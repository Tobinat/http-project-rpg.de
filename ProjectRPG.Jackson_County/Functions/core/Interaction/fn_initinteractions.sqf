...
*/
	...
	[
		["typeof CurrentCursorTarget == ""prpg_kamaz_6550"" && cursortarget animationPhase ""bur_rot"" > 0.99 && !(myjob == ""EMS"" || myJob == ""Fire"" || myJob == ""cop"" ) && ((player distance (getMarkerPos ""marker_5"")) < 50) && !("CG_OilBarrel" in MagazineCargo cursorTarget)"],
