...
*/
	...
	[
		["typeof CurrentCursorTarget == ""prpg_kamaz_6550"" && cursortarget animationPhase ""bur_rot"" > 0.99 && ((player distance (getMarkerPos ""marker_5"")) < 50) && !(""CG_OilBarrel"" in MagazineCargo cursorTarget)"],
