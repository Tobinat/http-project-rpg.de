...
_Btn4 ctrlSetStructuredText parsetext format["<t color='#33CC33'>TYTUL: %2 <t color='#ffffff'> <br/><br/> %1 <t color='#33CC33'> <br/><br/> NADAWCA: %3", _selectedmessage select 0, _selectedmessage select 1, _selectedmessage select 2];
_btn4 ctrlCommit 0;