...
if(tryingcall) exitwith { ["Bitte warten Sie, bevor sie jemanden anrufen wollen - Sie werden verbunden!", false] spawn domsg; };
if(PhonesRinging) exitwith { ["Du wirst grade angerufen, geh erstmal ran!", false] spawn domsg; };
