...
_POPUP ctrlSetStructuredText parseText format["<img size='1' image='prpg_data\icons'/> <t color='#FFCC00'><t size='0.9'>%1</t> <br/> <t size='2'>%2</t>",_task,_timeLeft];
...
_POPUP ctrlSetStructuredText parseText format["<img size='1' image='prpg_data\icons'/> <t color='#FFCC00'><t size='0.9'>%1</t> <br/> <t size='1'>%2</t>",_task,_error];
sleep 1;
player say "slideout";
