...
if(_houselevel == 3) then { ["Erfolreich","Du hast dein Haus auf Stufe 4 aufgerüstet, die Änderung wird nach Server neustart wirksam.",[0,255,0,1],""] call Client_fnc_showNotification; player setvariable ["houselevel",4,false]; [4,getplayeruid player] remoteExec ["server_fnc_synchouselevel",2]; [player,objNull,2,format ["%1 rüstete das Haus auf die vierte Stufe nach 50000$", name player],"50000", "", "4"] remoteExec ["server_fnc_economyLog", 2];};
if(_houselevel == 4) then { ["Erfolreich","Du hast dein Haus auf Stufe 5 aufgerüstet, die Änderung wird nach Server neustart wirksam.",[0,255,0,1],""] call Client_fnc_showNotification; player setvariable ["houselevel",5,false]; [5,getplayeruid player] remoteExec ["server_fnc_synchouselevel",2]; [player,objNull,2,format ["%1 rüstete das Haus auf die fuefte Stufe nach 50000$", name player],"50000", "", "5"] remoteExec ["server_fnc_economyLog", 2];};
if(_houselevel == 5) then { ["Erfolreich","Du hast dein Haus auf Stufe 6 aufgerüstet, die Änderung wird nach Server neustart wirksam.",[0,255,0,1],""] call Client_fnc_showNotification; player setvariable ["houselevel",6,false]; [6,getplayeruid player] remoteExec ["server_fnc_synchouselevel",2]; [player,objNull,2,format ["%1 rüstete das Haus auf die sechste Stufe nach 50000$", name player],"50000", "", "6"] remoteExec ["server_fnc_economyLog", 2];};
if(_houselevel == 6) then { ["Erfolreich","Du hast dein Haus auf Stufe 7 aufgerüstet, die Änderung wird nach Server neustart wirksam.",[0,255,0,1],""] call Client_fnc_showNotification; player setvariable ["houselevel",7,false]; [7,getplayeruid player] remoteExec ["server_fnc_synchouselevel",2]; [player,objNull,2,format ["%1 rüstete das Haus auf die sieben Stufe nach 50000$", name player],"50000", "", "7"] remoteExec ["server_fnc_economyLog", 2];};
if(_houselevel == 7) then { ["Erfolreich","Du hast dein Haus auf Stufe 8 aufgerüstet, die Änderung wird nach Server neustart wirksam.",[0,255,0,1],""] call Client_fnc_showNotification; player setvariable ["houselevel",8,false]; [8,getplayeruid player] remoteExec ["server_fnc_synchouselevel",2]; [player,objNull,2,format ["%1 rüstete das Haus auf die achte Stufe nach 50000$", name player],"50000", "", "8"] remoteExec ["server_fnc_economyLog", 2];};
