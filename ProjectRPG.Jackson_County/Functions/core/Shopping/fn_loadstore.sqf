...
if(_condition == "rarefish") then {
		_gunStorePistols = [
			...
			["prpg_workbench_normal_kit",nil,2,3],
			//clothes
...
if(_condition == "clothing") then {
	_clothing = [
		...
		["U_PMC_CombatUniformLS_ChckLB_GPBB",nil,100,3,1],
		["U_PMC_CombatUniformLS_ChckLR_SPBB",nil,100,3,1],
		["U_PMC_CombatUniformLS_ChckP_BPBB",nil,100,3,1],
		["U_PMC_CombatUniformRS_ChckDBS_GPSB",nil,100,3,1],
		["U_PMC_CombatUniformRS_ChckLB_GPBB",nil,100,3,1],
		["U_PMC_CombatUniformRS_ChckLR_SPBB",nil,100,3,1],
		["U_PMC_CombatUniformRS_ChckP_BPBB",nil,100,3,1],
		["U_PMC_BluePlaidShirt_BeigeCords",nil,100,3,1],
