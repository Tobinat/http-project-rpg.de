...
for "_i" from 0 to 1 step 0 do  {
	...
	if !(_mycash) exitwith { hint "Du hast kein Geld."; };
	if(_curFuel > 0.99) exitwith { hint "Das Fahzeug muss nicht Tanken!"; };
	if(player distance _startpos > 5) exitwith { hint "Du bist zu weit weg, Tankvorgang abgebrochen!"; };
