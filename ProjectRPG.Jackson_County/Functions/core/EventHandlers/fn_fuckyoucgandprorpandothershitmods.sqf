...
if (_item == "PRPG_WorkBench_Weapon_item") then { [] spawn client_fnc_weaponworkbench; [_item,0] spawn client_fnc_removeitem; closeDialog 0; };
if (_item == "PRPG_WorkBench_Clothing_item") then { [] spawn client_fnc_clothingworkbench; [_item,0] spawn client_fnc_removeitem; closeDialog 0; };
if (_item == "PRPG_WorkBench_Car_item") then { [] spawn client_fnc_carworkbench; [_item,0] spawn client_fnc_removeitem; closeDialog 0; };
if (_item == "PRPG_WorkBench_Normal_item") then { [] spawn client_fnc_workbench; [_item,0] spawn client_fnc_removeitem; closeDialog 0; };
...
//junky drink
if (_item IN ["np_coke","np_drpepper"]) then {playSound3D ["cg_sndimg\sounds\drink.ogg", player, false, getPosASL player, 6, 1, 45]; ["add","drink",50] call client_fnc_sustain; ["add","unhealthiness",6] call client_fnc_sustain; [_item,0] spawn client_fnc_removeitem; closeDialog 0; };
//intox system
