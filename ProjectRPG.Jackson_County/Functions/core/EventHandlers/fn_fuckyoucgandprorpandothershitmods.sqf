...
if (_item IN ["plp_bo_inv_BottleTequila"]) then {playSound3D ["PRPG_Data\sounds\drink.ogg", player, false, getPosASL player, 6, 1, 45]; player playmove "vvv_anim_drink"; client_intox = client_intox + 0.04; [] spawn client_fnc_intox; [_item,0] spawn client_fnc_removeitem; closeDialog 0; };
if (_item IN ["plp_bo_inv_BottleBitters","plp_bo_inv_BottleLiqCream","plp_bo_inv_BottleLiqOrange"]) then {playSound3D ["PRPG_Data\sounds\drink.ogg", player, false, getPosASL player, 6, 1, 45]; player playmove "vvv_anim_drink"; client_intox = client_intox + 0.05; [] spawn client_fnc_intox; [_item,0] spawn client_fnc_removeitem; closeDialog 0; };
if (_item IN ["plp_bo_inv_BottleBlueCorazol","plp_bo_inv_BottleGin"]) then {playSound3D ["PRPG_Data\sounds\drink.ogg", player, false, getPosASL player, 6, 1, 45]; player playmove "vvv_anim_drink"; client_intox = client_intox + 0.03; [] spawn client_fnc_intox; [_item,0] spawn client_fnc_removeitem; closeDialog 0; };
//junkfood&drink
if (_item IN
