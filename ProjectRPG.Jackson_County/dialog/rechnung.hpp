class Life_rechnung_give
{
	...
	class controls 
	{
		...
		class payTicket: Life_RscButtonMenu {
			idc = -1;
			text = "$STR_Ticket_GiveRechnung";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.6039])", "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.8039])", "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.1960])", 0.5};
...
class Life_rechnung_pay
{
	...
	class controls 
	{
		...
		class payRechnung: Life_RscButtonMenu {
			idc = -1;
		...
		class refuseRechnung : Life_RscButtonMenu {
			idc = -1;
