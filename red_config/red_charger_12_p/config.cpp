class CfgPatches
{
	class red_charger_12_p_config
	{
		units[]=
		{
			"red_charger_12_p_sheriff",
			"red_charger_12_p_state",
			"red_charger_12_p_u_sheriff",
			"red_charger_12_p_u_state",
			"red_charger_12_p_custom1",
			"red_charger_12_p_custom2",
			"red_charger_12_p_custom3",
			"red_charger_12_p_custom4",
			"red_charger_12_p_custom5",
...
class cfgVehicles
{
	...
	class red_charger_12_p_p_base: Car_F
	{
		model="\red_mods\red_charger_12_p\red_charger_12_p_p";
		...
		class eventhandlers
		{
			init="_this execVM ""red_mods\red_charger_12_p\scripts\init.sqf"";";
		...
		class UserActions
		{
			...
			class attach_pullbar
			{
				...
				radius=2;
				onlyForplayer="true";
				condition="side player == blufor && driver this == player && ((this animationPhase 'pushbar_1_hide') < 0.5)";
			...
			class lower_laptop
			{
				...
				radius=10;
				onlyForplayer="true";
				condition="side player == blufor && driver this == player && ((this animationPhase 'laptop_1_rot') < 0.5)";
			...
			class rotate_mount
			{
				...
				radius=10;
				onlyForplayer="true";
				condition="side player == blufor && driver this == player && ((this animationPhase 'mount_1_rot') < 0.5)";
	...
	class red_charger_12_p_sheriff: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Sheriff)";
		side=3;
	...
	class red_charger_12_p_state: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (State Trooper)";
		model="\red_mods\red_charger_12_p\red_charger_12_p_s";
		side=3;
		hiddenSelectionsTextures[]=
		{
			"red_config\red_charger_12_p\skins\state.paa"
		};
		class UserActions
		{
			class lightbaroff
	...
	class red_charger_12_p_u_sheriff: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Sheriff)(Slicktop)";
		model="\red_mods\red_charger_12_p\red_charger_12_p_u";
		side=3;
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_charger_12_p\skins\Sheriff.paa"
	...
	class red_charger_12_p_u_state: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (State Trooper)(Slicktop)";
		model="\red_mods\red_charger_12_p\red_charger_12_p_su";
		side=3;
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_charger_12_p\skins\state.paa"
	...
	class red_charger_12_p_custom1: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Custom 1)(P)";
		side=3;
		hiddenSelectionsTextures[]=
		{
			"red_config\red_charger_12_p\skins\custom1.paa"
		};
	};
	class red_charger_12_p_custom2: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Custom 2)(P)";
		side=3;
		hiddenSelectionsTextures[]=
		{
			"red_config\red_charger_12_p\skins\custom2.paa"
		};
	};
	class red_charger_12_p_custom3: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Custom 3)(P)";
		side=3;
		hiddenSelectionsTextures[]=
		{
			"red_config\red_charger_12_p\skins\custom3.paa"
		};
	};
	class red_charger_12_p_custom4: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Custom 4)(P)";
		side=3;
		hiddenSelectionsTextures[]=
		{
			"red_config\red_charger_12_p\skins\custom4.paa"
		};
	};
	class red_charger_12_p_custom5: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Custom 5)(P)";
		side=3;
		hiddenSelectionsTextures[]=
		{
			"red_config\red_charger_12_p\skins\custom5.paa"
		};
	};
	class red_charger_12_p_u_custom1: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Custom 1)(Slicktop)";
		model="\red_mods\red_charger_12_p\red_charger_12_p_u";
		side=3;
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_custom2: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Custom 2)(Slicktop)";
		model="\red_mods\red_charger_12_p\red_charger_12_p_u";
		side=3;
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_custom3: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Custom 3)(Slicktop)";
		model="\red_mods\red_charger_12_p\red_charger_12_p_u";
		side=3;
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_custom4: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Custom 4)(Slicktop)";
		model="\red_mods\red_charger_12_p\red_charger_12_p_u";
		side=3;
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_custom5: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Slicktop)(Custom 5)";
		model="\red_mods\red_charger_12_p\red_charger_12_p_u";
		side=3;
		hiddenSelectionsTextures[]=
		{
