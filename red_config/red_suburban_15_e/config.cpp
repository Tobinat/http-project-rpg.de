class CfgPatches
{
	class red_suburban_15_e_config
	{
		units[]=
		{
			...
			"red_suburban_15_e_custom3",
			"red_suburban_15_e_custom4",
			"red_suburban_15_e_custom5"
		};
		weapons[]={};
		requiredVersion=0.1;
		requiredAddons[]=
...
class cfgVehicles
{
	...
	class red_suburban_15_e_e_base: Car_F
	{
		...
		class eventhandlers
		{
			init="_this execVM ""red_mods\red_suburban_15_e\scripts\init.sqf"";";
		};
		class UserActions
		{
			class lightbaroff
			...
			class lower_laptop
			{
				...
				radius=10;
				onlyForplayer="true";
				condition="myJob == 'EMS' && driver this == player && ((this animationPhase 'laptop_1_rot') < 0.5)";
			...
			class rotate_mount
			{
				...
				radius=10;
				onlyForplayer="true";
				condition="myJob == 'EMS' && driver this == player && ((this animationPhase 'mount_1_rot') < 0.5)";
	...
	class red_suburban_15_e_ems: red_suburban_15_e_e_base
	{
		scope=2;
		displayName="2015 Chevrolet Suburban LTZ (EMS)";
		side=3;
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_suburban_15_e\skins\ems.paa"
		};
	};
	class red_suburban_15_e_ems2: red_suburban_15_e_e_base
	{
		scope=2;
		displayName="2015 Chevrolet Suburban LTZ (EMS)(V2)";
		side=3;
		model="\red_mods\red_suburban_15_e\red_suburban_15_e_t";
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_suburban_15_e\skins\ems.paa"
		};
		class UserActions
		{
			...
			class raiseboard
			{
				...
				radius=1;
				onlyForplayer="true";
				condition="myJob == 'EMS' && ((this animationPhase 'board_1_rot') < 0.5)";
	...
	class red_suburban_15_e_custom1: red_suburban_15_e_e_base
	{
		scope=2;
		...
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_suburban_15_e\skins\custom1.paa"
		};
	};
	class red_suburban_15_e_custom2: red_suburban_15_e_e_base
	{
		scope=2;
		...
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_suburban_15_e\skins\custom2.paa"
		};
	};
	class red_suburban_15_e_custom3: red_suburban_15_e_e_base
	{
		scope=2;
		...
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_suburban_15_e\skins\custom3.paa"
		};
	};
	class red_suburban_15_e_custom4: red_suburban_15_e_e_base
	{
		scope=2;
		...
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_suburban_15_e\skins\custom4.paa"
		};
	};
	class red_suburban_15_e_custom5: red_suburban_15_e_e_base
	{
		scope=2;
		...
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_suburban_15_e\skins\custom5.paa"
		};
	};
};
