...
class CfgSounds
{
	...
	class Siren1
	{
		...
		sound[]=
		{
			"red_suburban_15_pf\sounds\siren.wav",
			1,
			1
		};
		titles[]={};
	...
	class Siren2
	{
		...
		sound[]=
		{
			"red_suburban_15_pf\sounds\yelp.wav",
			1,
			1
		};
		titles[]={};
...
class cfgWeapons
{
	...
	class red_horn_airhorn: SportCarHorn
	{
		...
		drySound[]=
		{
			"red_suburban_15_pf\sounds\FederalAirhorn.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_takedown1: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_suburban_15_pf\sounds\Takedown1.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_takedown2: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_suburban_15_pf\sounds\Takedown2.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_pullover: SportCarHorn
	{
		...
		drySound[]=
		{
			"red_suburban_15_pf\sounds\PullOver.wav",
			2,
			1
		};
		scope=2;
	...
	class red_horn_handsup: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_suburban_15_pf\sounds\HandsUp.wav",
			2,
			1
		};
		scope=2;
	...
	class red_horn_passenger: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_suburban_15_pf\sounds\Passenger.wav",
			3,
			1
		};
		scope=2;
	...
	class red_horn_driver: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_suburban_15_pf\sounds\Driver.wav",
			3,
			1
		};
		scope=2;
...
class cfgVehicles
{
	...
	class red_suburban_15_p_f_ia: red_suburban_15_p_f_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_suburban_15_pf\skins\IA.paa"
		};
	};
	class red_suburban_15_p_f_gov: red_suburban_15_p_f_base
	{
		scope=2;
		displayName="2015 Suburban LTZ Government (Undercover)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_suburban_15_pf\skins\gov.paa"
		};
	};
