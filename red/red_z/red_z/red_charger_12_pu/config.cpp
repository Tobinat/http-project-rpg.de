...
class CfgSounds
{
	...
	class Siren1
	{
		...
		sound[]=
		{
			"red_charger_12_pu\sounds\siren.wav",
			1,
			1
		};
		titles[]={};
	...
	class Siren2
	{
		...
		sound[]=
		{
			"red_charger_12_pu\sounds\yelp.wav",
			1,
			1
		};
		titles[]={};
...
class cfgWeapons
{
	...
	class red_horn_airhorn: SportCarHorn
	{
		...
		drySound[]=
		{
			"red_charger_12_pu\sounds\FederalAirhorn.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_takedown1: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_charger_12_pu\sounds\Takedown1.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_takedown2: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_charger_12_pu\sounds\Takedown2.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_pullover: SportCarHorn
	{
		...
		drySound[]=
		{
			"red_charger_12_pu\sounds\PullOver.wav",
			2,
			1
		};
		scope=2;
	...
	class red_horn_handsup: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_charger_12_pu\sounds\HandsUp.wav",
			2,
			1
		};
		scope=2;
	...
	class red_horn_passenger: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_charger_12_pu\sounds\Passenger.wav",
			3,
			1
		};
		scope=2;
	...
	class red_horn_driver: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_charger_12_pu\sounds\Driver.wav",
			3,
			1
		};
		scope=2;
...
class cfgVehicles
{
	...
	class red_charger_12_p_u_base: Car_F
	{
		model="\red_charger_12_pu\red_charger_12_p_u";
		...
		class eventhandlers
		{
			init="_this execVM ""red_charger_12_p\scripts\init.sqf"";";
		};
		class UserActions
		{
			class codeone
			...
			class Reset
			{
				...
				statement="this setobjecttextureglobal [24,'\red_charger_12_p\textures\pic0.paa']; this setobjecttextureglobal [25,'\red_charger_12_p\textures\pic0.paa']; this setobjecttextureglobal [26,'\red_charger_12_p\textures\pic0.paa']; Prevspeed = 0;";
				onlyForplayer=1;
			};
		};
		class HitPoints2
	...
	class red_charger_12_p_u_statetrooper: red_charger_12_p_u_base
	{
		scope=2;
		...
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_charger_12_pu\skins\StateTrooper.paa"
		};
	};
	class red_charger_12_p_u_sheriff: red_charger_12_p_u_base
	{
		scope=2;
		...
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_charger_12_pu\skins\sheriff.paa"
		};
	};
	class red_charger_12_p_u_sheriff_b: red_charger_12_p_u_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 Sheriff (Hell) (Slicktop)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_charger_12_pu\skins\sheriff_b.paa"
		};
	};
	class red_charger_12_p_u_black: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Black)(Slicktop)";
	...
	class red_charger_12_p_u_aqua: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Aqua)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_darkblue: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Dark Blue)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_green: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Green)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_red: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Red)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_pink: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Pink)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_yellow: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Yellow)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_orange: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Orange)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_white: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (White)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_purple: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Purple)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_darkgreen: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Dark Green)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
	...
	class red_charger_12_p_u_darkred: red_charger_12_p_u_base
	{
		scope=2;
		scopeCurator=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="2012 Dodge Charger SRT8 (Dark Red)(Slicktop)";
		vehicleClass="red_civilian";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
