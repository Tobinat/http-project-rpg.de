...
class cfgVehicles
{
	...
	{
		model="\red_suburban_15_p\red_suburban_15_p_p";
		...
		{
			"\red_suburban_15_p\colours\black.paa"
		};
		terrainCoef=0.5;
		turnCoef=2.5;
		precision=10;
	...
	class red_suburban_15_p_trooper: red_suburban_15_p_p_base
	{
		scope=0;
		scopeCurator=0;
		displayName="2015 Suburban LTZ Trooper";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_suburban_15_p\skins\suburbantrooper.paa"
		};
	};
	class red_suburban_15_p_sheriff: red_suburban_15_p_p_base
	{
		scope=2;
		displayName="2015 Suburban LTZ Sheriff";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_suburban_15_p\skins\sheriff.paa"
		};
	};
	class red_suburban_15_p_dea: red_suburban_15_p_p_base
	{
		scope=2;
		displayName="2015 Suburban LTZ DEA";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_suburban_15_p\skins\dea.paa"
		};
	};
	class red_suburban_15_p_fbi: red_suburban_15_p_p_base
	{
		scope=2;
		displayName="2015 Suburban LTZ FBI";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_suburban_15_p\skins\fbi.paa"
		};
	};
	class red_suburban_15_p_gov: red_suburban_15_p_p_base
	{
		scope=2;
		displayName="2015 Suburban LTZ Government";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_suburban_15_p\skins\gov.paa"
		};
	};
	class red_suburban_15_p_unmarked: red_suburban_15_p_p_base
	{
		scope=2;
		displayName="2015 Suburban LTZ Unmarked";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
			"\red_suburban_15_p\colours\white.paa"
		};
	};
	class red_suburban_15_p_unmarked_2: red_suburban_15_p_p_base
	{
		scope=2;
		displayName="2015 Suburban LTZ Unmarked V2";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		author="Redhotsteel";
