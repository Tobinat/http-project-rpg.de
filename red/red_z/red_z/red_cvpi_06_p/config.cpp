...
class CfgSounds
{
	...
	class Siren1
	{
		...
		sound[]=
		{
			"red_cvpi_06_p\sounds\siren.wav",
			1,
			1
		};
		titles[]={};
...
class cfgWeapons
{
	...
	class red_horn_airhorn: SportCarHorn
	{
		...
		drySound[]=
		{
			"red_cvpi_06_p\sounds\FederalAirhorn.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_takedown1: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_cvpi_06_p\sounds\Takedown1.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_takedown2: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_cvpi_06_p\sounds\Takedown2.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_pullover: SportCarHorn
	{
		...
		drySound[]=
		{
			"red_cvpi_06_p\sounds\PullOver.wav",
			2,
			1
		};
		scope=2;
	...
	class red_horn_handsup: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_cvpi_06_p\sounds\HandsUp.wav",
			2,
			1
		};
		scope=2;
	...
	class red_horn_passenger: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_cvpi_06_p\sounds\Passenger.wav",
			3,
			1
		};
		scope=2;
	...
	class red_horn_driver: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_cvpi_06_p\sounds\Driver.wav",
			3,
			1
		};
		scope=2;
...
class cfgVehicles
{
	...
	class red_cvpi_06_p_p_base: Car_F
	{
		...
		class UserActions
		{
			...
			class Reset
			{
				...
				statement="this setobjecttextureglobal [24,'\red_cvpi_06_p\textures\pic0.paa']; this setobjecttextureglobal [25,'\red_cvpi_06_p\textures\pic0.paa']; this setobjecttextureglobal [26,'\red_cvpi_06_p\textures\pic0.paa']; Prevspeed = 0;";
				onlyForplayer=1;
			};
		};
		class HitPoints2
	...
	class red_cvpi_06_p_trooper: red_cvpi_06_p_p_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_cvpi_06_p\skins\StateTrooper.paa"
		};
	};
	...
	class red_cvpi_06_p_sheriff: red_cvpi_06_p_p_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_cvpi_06_p\skins\sheriff.paa"
		};
	};
	class red_cvpi_06_p_sheriff_w: red_cvpi_06_p_p_base
	{
		scope=2;
		displayName="2006 CVPI Sheriff (Hell)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_cvpi_06_p\skins\sheriff_w.paa"
		};
	};
	class red_cvpi_06_p_sheriff_b: red_cvpi_06_p_p_base
	{
		scope=2;
		displayName="2006 CVPI Sheriff (Dunkel)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		author="Redhotsteel";
		hiddenSelectionsTextures[]=
		{
			"\red_z\red_cvpi_06_p\skins\sheriff_b.paa"
		};
	};
};
class cfgMods
