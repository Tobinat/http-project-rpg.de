...
class CfgSounds
{
	...
	class Siren1
	{
		...
		sound[]=
		{
			"red_charger_12_p\sounds\siren.wav",
			1,
			1
		};
		titles[]={};
	...
	class Siren2
	{
		...
		sound[]=
		{
			"red_charger_12_p\sounds\yelp.wav",
			1,
			1
		};
		titles[]={};
...
class cfgWeapons
{
	...
	class red_horn_airhorn: SportCarHorn
	{
		...
		drySound[]=
		{
			"red_charger_12_p\sounds\FederalAirhorn.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_takedown1: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_charger_12_p\sounds\Takedown1.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_takedown2: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_charger_12_p\sounds\Takedown2.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_pullover: SportCarHorn
	{
		...
		drySound[]=
		{
			"red_charger_12_p\sounds\PullOver.wav",
			2,
			1
		};
		scope=2;
	...
	class red_horn_handsup: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_charger_12_p\sounds\HandsUp.wav",
			2,
			1
		};
		scope=2;
	...
	class red_horn_passenger: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_charger_12_p\sounds\Passenger.wav",
			3,
			1
		};
		scope=2;
	...
	class red_horn_driver: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_charger_12_p\sounds\Driver.wav",
			3,
			1
		};
		scope=2;
...
class cfgVehicles
{
	...
	{
		model="\red_charger_12_p\red_charger_12_p_p";
	...
	class red_charger_12_p_statetrooper: red_charger_12_p_p_base
	{
		scope=0;
		scopeCurator=0;
		...
		hiddenSelectionsTextures[]=
		{
			"red_z\red_charger_12_p\skins\StateTrooper.paa"
		};
	};
	class red_charger_12_p_sheriff_b: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 Sheriff (Dunkel)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		hiddenSelectionsTextures[]=
		{
			"red_z\red_charger_12_p\skins\sheriff_b.paa"
		};
	};
	class red_charger_12_p_black: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Unmarked Black)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		hiddenSelectionsTextures[]=
	...
	class red_charger_12_p_white: red_charger_12_p_p_base
	{
		scope=2;
		displayName="2012 Dodge Charger SRT8 (Unmarked White)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		hiddenSelectionsTextures[]=
