...
if(!isNil "life_server_extDB_notLoaded") exitWith {
	["extDB kann nicht geladen werden, bitte wenden Sie sich an einen Administrator!", false] spawn domsg;
};
[] call SOCK_fnc_dataQuery;
waitUntil {life_session_completed};
["Server bereit! Client-Setup erfolgreich!", false] spawn domsg;
