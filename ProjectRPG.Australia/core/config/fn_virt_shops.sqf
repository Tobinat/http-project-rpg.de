...
switch (_shop) do
{
	...
	case "market": {["Market",["condom","tierope","bec","cigarette","lockpick","fuelF","boltcutter","storagesmall"]]};
	...
	case "ems": {["EMS Item Shop",["airkit","panicbutton","coffee","donuts","bec","water","rabbit","apple","redgull","tbacon","peach","RoadBlockWood","RoadCone","RoadConeStrip","RoadConeB","RoadConeStripB","fuelF"]]};
