...
5 cutText ["","PLAIN"];
if(_target getVariable ["EVIDO",ObjNull] != player) exitWith { ["Someone is already gathering this evidence..", false] spawn domsg; };
if(_bad == 1) exitWith { ["You moved to far from the evidence", false] spawn domsg; };
