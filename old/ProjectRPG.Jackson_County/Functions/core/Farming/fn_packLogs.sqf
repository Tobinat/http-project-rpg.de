...
*/
	...
	if(totalLogs == 23) exitwith { hint "Du kannst nicht mehr Laden."; };
	...
	if(totalLogs == 1) exitwith {
		...
		[player,objNull,29,format ["%1 hat Holzstaemme auf deinen LKW geladen,Menge: %2",name player, totalLogs],totalLogs] remoteExec ["server_fnc_actionLog", 2];
	};
