...
try {
...

	{
		...
		if (isNull _topConfig) then {
			...
			_ctrlActionText ctrlSetPosition [0.445312 * safezoneW + safezoneX, 0.863 * safezoneH + safezoneY, 0.237187 * safezoneW, 0.040 * safezoneH];
			...
			_ctrlActionText ctrlSetPosition [0.345312 * safezoneW + safezoneX, 0.863 * safezoneH + safezoneY, 0.237187 * safezoneW, 0.040 * safezoneH];
