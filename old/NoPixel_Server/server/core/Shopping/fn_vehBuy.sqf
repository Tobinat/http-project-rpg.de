...
if((count _information) isEqualTo 0) exitWith { [_buyer,6,format ["%1 konnte sein Auto nicht kaufen und verlor %2",name _buyer,_price],_price,"",""] call server_fnc_vehicleLog; };
...
[player,6,format ["%1 hat ein Fahrzeug vom Typ %2 für einen Betrag von %3 von %4 gekauft",name player,_vehicleName,name _player],_price,_className,_vehicleName] call server_fnc_vehicleLog;
deleteVehicle _veh;
