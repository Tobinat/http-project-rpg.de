...
if (_exists) then {
	hint parseText "<t color='#01DF01'>--UPDATED--</t><br/><t color='#01DF01'>PREIS ANGEPASST! WIRD MIT DER NÄCHSTEN AKTUALISIERUNG ÜBERNOMMEN!</t>";
	[_tochangeNameText,_tochangePriceNumber] remoteExec ["TON_fnc_changePrice",2];
} else {
	hint parseText "<t color='#FF0000'>--ERROR--</t><br/><t color='#FF0000'>ANGEFORDERTER GEGENSTAND EXISTIER NICHT!</t>";
};