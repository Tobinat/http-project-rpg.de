...
["Dir wurden 10$ für ein Job Auto in Rechnung gestellt.", true] spawn doquickmsg;
...
if (_jobType == "Wood Logging") exitwith {
	...
	hint "Du hast Kleidung im Auto, benutz sie!";
};
...
if (_jobType == "mail") exitwith {
	...
	hint "Du hast Kleidung im Auto, nutze sie!";
};
...
if (_jobType == "security") exitwith {
	...
	hint "Du hast Kleidung im Auto, nutze sie - Im Waffenladen bekommste nen Taser.";
};
...
if (_jobType == "NewsMan") exitwith {
	...
	hint "Du hast Kleidung & Utensilien im Auto, nutze sie!";
};
