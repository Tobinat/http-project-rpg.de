...
["Jage alles in dem Gebiet. Vergiss nicht die Tiere zu verwerten!",false] spawn domsg;
im_hunting = true;
private["_animal","_tempPos"];
_chances = 35 + (floor random 15);
huntarray = ["Sheep_random_F","Cock_random_F","Hen_random_F","Goat_random_F"];
if(player distance (getmarkerpos "hunting_area") > 300) exitwith { ["Du hast das Jagdgebiet verlassen",false] spawn domsg; };
