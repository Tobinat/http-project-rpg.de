...
{
	["Das Rennen wird durch ein Fahrzeug blockiert und kann nicht gestartet werden.", false] spawn domsg;
};
...
life_koil_rally = 0;
[format["Die Rally ist vorbei - du bekommst %1 mit %2 Sekunden Zeit.",_totalcash,_timer], false] spawn domsg;
[0,format["%1 had %2 seconds remaining on the time trial.",name player, _timer]] remoteExecCall ["life_fnc_broadcast", -2];
