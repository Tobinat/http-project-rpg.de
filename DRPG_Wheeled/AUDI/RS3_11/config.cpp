...
//Produced on Tue Apr 26 11:47:22 2016 : Created on Tue Apr 26 11:47:22 2016
//http://dev-heaven.net/projects/list_files/mikero-pbodll
////////////////////////////////////////////////////////////////////

#define _ARMA_

//Class DRPG_Wheeled : AUDI\RS3_11\config.bin{
...
class CfgVehicles
{
	...
	class DRPG_11RS3_Base: Car_F
	{
		model = "\DRPG_Wheeled\AUDI\RS3_11\DRPG_RS3_11";
		...
		soundEngineOnInt[] = {"DRPG_VehicleData\sounds\SPORTS_V8\int_start",0.39810717,1};
		soundEngineOnExt[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_start",0.4466836,1,200};
		soundEngineOffInt[] = {"DRPG_VehicleData\sounds\SPORTS_V8\int_stop",0.39810717,1};
		soundEngineOffExt[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_stop",0.4466836,1,200};
		...
		class Sounds
		{
			class Idle_ext
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\int_idle",0.22387211,1,150};
			...
			class Engine
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_1000",0.2818383,1,200};
			...
			class Engine1_ext
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_2000",0.3548134,1,240};
			...
			class Engine2_ext
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_3000",0.39810717,1,280};
			...
			class Engine3_ext
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_4000",0.4466836,1,320};
			...
			class Engine4_ext
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_5000",0.5011872,1,360};
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_2000",0.63095737,1,280};
				frequency = "0.8	+		((rpm/	6900) factor[(1300/	6900),(3100/	6900)])*0.2";
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_3000",0.70794576,1,320};
				frequency = "0.8	+	((rpm/	6900) factor[(2200/	6900),(4100/	6900)])*0.2";
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_4000",0.7943282,1,360};
				frequency = "0.8	+	((rpm/	6900) factor[(3300/	6900),(4900/	6900)])*0.2";
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_5000",1,1,400};
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\ext_6000",1.2589254,1,450};
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\int_1000",0.3548134,1};
				frequency = "0.8	+	((rpm/	6900) factor[(900/	6900),(2100/	6900)])*0.2";
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\int_2000",0.39810717,1};
				frequency = "0.8	+		((rpm/	6900) factor[(1300/	6900),(3100/	6900)])*0.2";
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\int_3000",0.4466836,1};
				frequency = "0.8	+	((rpm/	6900) factor[(2200/	6900),(4100/	6900)])*0.2";
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\int_4000",0.5011872,1};
				frequency = "0.8	+	((rpm/	6900) factor[(3300/	6900),(4900/	6900)])*0.2";
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\int_5000",0.56234133,1};
				frequency = "0.8	+	((rpm/	6900) factor[(4200/	6900),(6200/	6900)])*0.3";
			...
			{
				sound[] = {"DRPG_VehicleData\sounds\SPORTS_V8\int_6000",0.63095737,1};
				frequency = "0.9	+	((rpm/	6900) factor[(5100/	6900),(6900/	6900)])*0.2";
	...
	class DRPG_11RS3_Black: DRPG_11RS3_Base
	{
		scope = 2;
		scopeCurator = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2011 Audi RS3 (Black)";
		hiddenSelectionsTextures[] = {"DRPG_VehicleData\common\black.paa"};
	};
	class DRPG_11RS3_White: DRPG_11RS3_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2011 Audi RS3 (White)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\white.paa","","","","","","","","","",""};
	};
	class DRPG_11RS3_Red: DRPG_11RS3_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2011 Audi RS3 (Red)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\Red.paa","","","","","","","","","",""};
	};
	class DRPG_11RS3_blue: DRPG_11RS3_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2011 Audi RS3 (Blue)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\blue.paa","","","","","","","","","",""};
	};
	class DRPG_11RS3_Green: DRPG_11RS3_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2011 Audi RS3 (Green)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\green.paa","","","","","","","","","",""};
	};
	class DRPG_11RS3_Orange: DRPG_11RS3_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2011 Audi RS3 (Orange)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\orange.paa","","","","","","","","","",""};
	};
	class DRPG_11RS3_Pink: DRPG_11RS3_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2011 Audi RS3 (Pink)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\pink.paa","","","","","","","","","",""};
	};
	class DRPG_11RS3_Purple: DRPG_11RS3_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2011 Audi RS3 (Purple)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\purple.paa","","","","","","","","","",""};
	};
	class DRPG_11RS3_Yellow: DRPG_11RS3_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2011 Audi RS3 (Yellow)";
