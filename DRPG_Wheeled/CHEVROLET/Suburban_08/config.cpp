...
//Class DRPG_Wheeled : CHEVROLET\Suburban_08\config.bin{
...
class CfgVehicles
{
	...
	class DRPG_08Suburban_Base: Car_F
	{
		model = "\DRPG_Wheeled\CHEVROLET\Suburban_08\DRPG_Suburban_08";
	...
	class DRPG_08Suburban_Black: DRPG_08Suburban_Base
	{
		scope = 2;
		scopeCurator = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2008 Chevrolet Suburban (Black)";
		hiddenSelectionsTextures[] = {"DRPG_VehicleData\common\black.paa"};
	};
	class DRPG_08Suburban_White: DRPG_08Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2008 Chevrolet Suburban (White)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\white.paa","","","","","","","","","",""};
	};
	class DRPG_08Suburban_Red: DRPG_08Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2008 Chevrolet Suburban (Red)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\Red.paa","","","","","","","","","",""};
	};
	class DRPG_08Suburban_blue: DRPG_08Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2008 Chevrolet Suburban (Blue)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\blue.paa","","","","","","","","","",""};
	};
	class DRPG_08Suburban_Green: DRPG_08Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2008 Chevrolet Suburban (Green)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\green.paa","","","","","","","","","",""};
	};
	class DRPG_08Suburban_Orange: DRPG_08Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
	...
	class DRPG_08Suburban_Pink: DRPG_08Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2008 Chevrolet Suburban (Pink)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\pink.paa","","","","","","","","","",""};
	};
	class DRPG_08Suburban_Purple: DRPG_08Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2008 Chevrolet Suburban (Purple)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\purple.paa","","","","","","","","","",""};
	};
	class DRPG_08Suburban_Yellow: DRPG_08Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2008 Chevrolet Suburban (Yellow)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\yellow.paa","","","","","","","","","",""};
	};
	class DRPG_08Suburban_P_U: DRPG_08Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		...
		displayName = "2008 Chevrolet Suburban PPV/UM";
		model = "\DRPG_Wheeled\CHEVROLET\Suburban_08\DRPG_Suburban_08_P_U";
