...
//Class DRPG_Wheeled : CHEVROLET\Suburban_06\config.bin{
...
class CfgVehicles
{
	...
	class DRPG_06Suburban_Base: Car_F
	{
		model = "\DRPG_Wheeled\CHEVROLET\Suburban_06\DRPG_Suburban_06";
	...
	class DRPG_06Suburban_Black: DRPG_06Suburban_Base
	{
		scope = 2;
		scopeCurator = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Chevrolet Suburban (Black)";
		hiddenSelectionsTextures[] = {"DRPG_VehicleData\common\black.paa"};
	};
	class DRPG_06Suburban_White: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Chevrolet Suburban (White)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\white.paa","","","","","","","","","",""};
	};
	class DRPG_06Suburban_Red: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Chevrolet Suburban (Red)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\Red.paa","","","","","","","","","",""};
	};
	class DRPG_06Suburban_blue: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Chevrolet Suburban (Blue)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\blue.paa","","","","","","","","","",""};
	};
	class DRPG_06Suburban_Green: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Chevrolet Suburban (Green)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\green.paa","","","","","","","","","",""};
	};
	class DRPG_06Suburban_Orange: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
	...
	class DRPG_06Suburban_Pink: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Chevrolet Suburban (Pink)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\pink.paa","","","","","","","","","",""};
	};
	class DRPG_06Suburban_Purple: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Chevrolet Suburban (Purple)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\purple.paa","","","","","","","","","",""};
	};
	class DRPG_06Suburban_Yellow: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Chevrolet Suburban (Yellow)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\green.paa","","","","","","","","","",""};
	};
	class DRPG_06Suburban_DOJ: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Chevrolet Suburban (Justice)";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\CHEVROLET\Suburban_06\LIVERY\06ChevroletSuburban_DOJ.paa"};
	};
	class DRPG_06Suburban_P_P: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		...
		displayName = "2006 Chevrolet Suburban PPV";
		model = "\DRPG_Wheeled\CHEVROLET\Suburban_06\DRPG_Suburban_06_P_P";
		...
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\CHEVROLET\Suburban_06\LIVERY\08Suburban_POLICE.paa"};
		weapons[] = {"airhorn","Yelp","Whelen_Manual","Whelen_Howler","Whelen_Takedown","takedown2"};
		class eventhandlers
		{
			init = "(_this select 0) execVM ""\PRPG_Data\Scripts\Plate_cop.sqf""; _this execVM ""\PRPG_Data\Scripts\VehicleInit.sqf"";";
		};
		class UserActions
		{
			class beacons_start
	...
	class DRPG_06Suburban_P_FBI: DRPG_06Suburban_P_P
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "06 Chevrolet Suburban (FBI)";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\CHEVROLET\Suburban_06\LIVERY\06ChevroletSuburban_FBI.paa"};
	};
	class DRPG_06Suburban_P_LVPD: DRPG_06Suburban_P_P
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "06 Chevrolet Suburban (LVPD)";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\CHEVROLET\Suburban_06\LIVERY\06ChevroletSuburban_LVPD.paa"};
	};
	class prpg_chevy_slpd_sp: DRPG_06Suburban_P_P
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "Chevy S.L State Police";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\CHEVROLET\Suburban_06\LIVERY\CHEVY_PRPG_STATE.paa"};
	};
	class prpg_chevy_slpd: DRPG_06Suburban_P_P
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "Chevy S.L.P.D";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\CHEVROLET\Suburban_06\LIVERY\06SuburbanSheriff.paa"};
	};
	class prpg_chevy_slpd_sv: DRPG_06Suburban_P_P
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
	...
	class DRPG_06Suburban_P_State: DRPG_06Suburban_P_P
	{
		...
		side = 3;
		faction = "CIV_F";
		displayName = "06 Chevrolet Suburban (State)";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\CHEVROLET\Suburban_06\LIVERY\06SuburbanStatePolice.paa"};
	};
	class DRPG_06Suburban_EMS: DRPG_06Suburban_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		...
		vehicleClass = "DRPG_Police";
		weapons[] = {"airhorn","Yelp","Whelen_Manual","Whelen_Howler","Whelen_Takedown","takedown2"};
		displayName = "2006 Chevrolet Suburban EMS";
		model = "\DRPG_Wheeled\CHEVROLET\Suburban_06\DRPG_Suburban_06_EMS";
		hiddenSelections[] = {"camo1","plate1","plate2","plate3","plate4","plate5","plate6","plate7","SPD_1","SPD_2","SPD_3","LF_1","LF_2","LF_3","UNIT_1","UNIT_2","UNIT_3"};
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\CHEVROLET\Suburban_06\LIVERY\06Suburban_EMS.paa"};
		class eventhandlers
		{
			init = "(_this select 0) execVM ""\PRPG_Data\Scripts\Plate_skins.sqf""; _this execVM ""\PRPG_Data\Scripts\VehicleInit.sqf"";";
		};
		class UserActions
		{
			class beacons_start
