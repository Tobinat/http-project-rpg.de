...
//Class DRPG_Wheeled : BMW\M5_12\config.bin{
...
class CfgVehicles
{
	...
	class DRPG_12M5_Base: Car_F
	{
		model = "\DRPG_Wheeled\BMW\M5_12\DRPG_M5_12";
	...
	class DRPG_12M5_Black: DRPG_12M5_Base
	{
		scope = 2;
		scopeCurator = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (Black)";
		hiddenSelectionsTextures[] = {"DRPG_VehicleData\common\black.paa"};
	};
	class DRPG_12M5_White: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (White)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\white.paa","","","","","","","","","",""};
	};
	class DRPG_12M5_Red: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (Red)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\Red.paa","","","","","","","","","",""};
	};
	class DRPG_12M5_blue: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (Blue)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\blue.paa","","","","","","","","","",""};
	};
	class DRPG_12M5_Green: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (Green)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\green.paa","","","","","","","","","",""};
	};
	class DRPG_12M5_Orange: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (Orange)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\orange.paa","","","","","","","","","",""};
	};
	class DRPG_12M5_Pink: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (Pink)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\pink.paa","","","","","","","","","",""};
	};
	class DRPG_12M5_Purple: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (Purple)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\purple.paa","","","","","","","","","",""};
	};
	class DRPG_12M5_Yellow: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (Yellow)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\Yellow.paa","","","","","","","","","",""};
	};
	class DRPG_12M5_LAC: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (LAC)";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\BMW\M5_12\LIVERY\12M5_LAC.paa"};
	};
	class DRPG_12M5_DOJ: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 (Justice)";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\BMW\M5_12\LIVERY\12M5_Police_DOJ.paa"};
	};
	class DRPG_12M5_P_P: DRPG_12M5_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
	...
	class prpg_bmw_slpd: DRPG_12M5_P_P
	{
		scope = 2;
		displayName = "BMW S.L.P.D";
		model = "\DRPG_Wheeled\BMW\M5_12\DRPG_M5_12_P_P";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\BMW\M5_12\LIVERY\12M5_Police_LVPD.paa"};
	};
	class prpg_bmw_slpd_sv: DRPG_12M5_P_P
	{
		scope = 2;
		displayName = "BMW S.L.P.D Supervisor";
		model = "\DRPG_Wheeled\BMW\M5_12\DRPG_M5_12_P_P";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\BMW\M5_12\LIVERY\12M5_Police_SV.paa"};
	};
	class DRPG_12M5_P_SHERIFF: DRPG_12M5_P_P
	{
		scope = 2;
		displayName = "BMW M5 - Sheriff";
		model = "\DRPG_Wheeled\BMW\M5_12\DRPG_M5_12_P_P";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\BMW\M5_12\LIVERY\12M5_Police_Sheriff.paa"};
	};
	class DRPG_12M5_P_FBI: DRPG_12M5_P_P
	{
		scope = 2;
		displayName = "BMW M5 - FBI";
		model = "\DRPG_Wheeled\BMW\M5_12\DRPG_M5_12_P_P";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\BMW\M5_12\LIVERY\12M5_Police_FBI.paa"};
	};
	class DRPG_12M5_P_STATE: DRPG_12M5_P_P
	{
		scope = 2;
		displayName = "BMW M5 - State Police";
		model = "\DRPG_Wheeled\BMW\M5_12\DRPG_M5_12_P_P";
		hiddenSelectionsTextures[] = {"\DRPG_Wheeled\BMW\M5_12\LIVERY\12M5_Police_SP.paa"};
	};
	class DRPG_12M5_P_FDLV: DRPG_12M5_P_P
	{
		scope = 2;
	...
	class prpg_12M5_EM: DRPG_12M5_Base
	{
		...
		side = 3;
		faction = "CIV_F";
		displayName = "2012 BMW M5 EMS";
		model = "\DRPG_Wheeled\BMW\M5_12\DRPG_M5_12_EMS";
		vehicleClass = "DRPG_Police";
