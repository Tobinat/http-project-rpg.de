...
//Class DRPG_Wheeled : FORD\Victoria_06\config.bin{
...
class CfgVehicles
{
	...
	class DRPG_06Victoria_Base: Car_F
	{
		model = "\DRPG_Wheeled\FORD\Victoria_06\DRPG_Victoria_06";
	...
	class DRPG_06Victoria_Black: DRPG_06Victoria_Base
	{
		scope = 2;
		scopeCurator = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (Black)";
		hiddenSelectionsTextures[] = {"DRPG_VehicleData\common\black.paa"};
	};
	class DRPG_06Victoria_White: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (White)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\white.paa","","","","","","","","","",""};
	};
	class DRPG_06Victoria_Red: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (Red)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\Red.paa","","","","","","","","","",""};
	};
	class DRPG_06Victoria_blue: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (Blue)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\blue.paa","","","","","","","","","",""};
	};
	class DRPG_06Victoria_Green: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (Green)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\green.paa","","","","","","","","","",""};
	};
	class DRPG_06Victoria_Orange: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (Orange)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\orange.paa","","","","","","","","","",""};
	};
	class DRPG_06Victoria_Pink: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (Pink)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\pink.paa","","","","","","","","","",""};
	};
	class DRPG_06Victoria_Purple: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (Purple)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\purple.paa","","","","","","","","","",""};
	};
	class DRPG_06Victoria_Yellow: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (Yellow)";
		hiddenSelectionsTextures[] = {"\DRPG_VehicleData\common\yellow.paa","","","","","","","","","",""};
	};
	class DRPG_06Victoria_LAC: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (LAC)";
		hiddenSelectionsTextures[] = {"DRPG_Wheeled\FORD\Victoria_06\LIVERY\06VICTORIA_LAC.paa"};
	};
	class DRPG_06Victoria_DOJ: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2006 Ford Crown Victoria (Justice)";
		hiddenSelectionsTextures[] = {"DRPG_Wheeled\FORD\Victoria_06\LIVERY\06VICTORIA_DOJ.paa"};
	};
	class DRPG_06Victoria_P_P: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
	...
	class DRPG_06Victoria_P_LVPD: DRPG_06Victoria_P_P
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "Ford Crown Victoria (LVPD)";
		hiddenSelectionsTextures[] = {"DRPG_Wheeled\FORD\Victoria_06\LIVERY\06VICTORIA_LVPD.paa"};
	};
	class prpg_cv_slpd_sv: DRPG_06Victoria_P_P
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "Ford CV S.L.P.D Supervisor";
		hiddenSelectionsTextures[] = {"DRPG_Wheeled\FORD\Victoria_06\LIVERY\06VICTORIA_SV.paa"};
	};
	class prpg_cv_slpd: DRPG_06Victoria_P_P
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
	...
	class DRPG_06Victoria_P_FBI: DRPG_06Victoria_P_P
	{
		...
		side = 3;
		faction = "CIV_F";
		displayName = "Ford Crown Victoria (FBI)";
		hiddenSelectionsTextures[] = {"DRPG_Wheeled\FORD\Victoria_06\LIVERY\06VICTORIA_FBI.paa"};
	};
	class DRPG_06Victoria_P_T: DRPG_06Victoria_Base
	{
		scope = private;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		vehicleClass = "DRPG_Police";
		displayName = "2006 Ford Crown Victoria TPV";
		model = "\DRPG_Wheeled\FORD\Victoria_06\DRPG_Victoria_06_P_P";
		hiddenSelectionsTextures[] = {"DRPG_Wheeled\FORD\Victoria_06\LIVERY\06Victoria_Traffic.paa"};
	};
	...
	class DRPG_06Victoria_P_R: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		vehicleClass = "DRPG_Police";
		displayName = "2006 Ford Crown Victoria PPV/RLB";
		...
		class Reflectors
		{
			...
			class rota1
			{
				...
				coneFadeCoef = 10;
				intensity = 2;
				position = "lightrota1pos";
				direction = "lightrota1dir";
				hitpoint = "lightrota1";
				selection = "rota1";
				useFlare = 1;
				dayLight = 1;
		...
		aggregateReflectors[] = {{"LightCarHeadL01","LightCarHeadL02"},{"LightCarHeadR01","LightCarHeadR02"},{"rota1","rota2","rota3","rota4","rota5"}};
		class UserActions
		{
			class beacons_start
			{
				...
				displayNameDefault = "Lightbar On";
				position = "drivewheel_axis";
				priority = 1.5;
				radius = 1.8;
				animPeriod = 2;
				onlyForPlayer = 0;
				condition = "this animationPhase ""IdleHide"" < 0.2 AND Alive(this) AND driver this == player";
				statement = "this animate [""BeaconsStart"",0.2]; this animate[""IdleHide"",1]; this animate[""BeaconUnhide"",1]; ";
			};
			class beacons_stop: beacons_start
			{
				userActionID = 51;
				displayName = "Lightbar Off";
				displayNameDefault = "Lightbar Off";
				condition = "this animationPhase ""IdleHide"" > 0.2 AND Alive(this) AND driver this == player";
				statement = "this animate [""BeaconsStart"",0.2];this animate[""IdleHide"",0]; this animate[""BeaconUnhide"",0];";
			};
		};
	};
	class prpg_06Victoria_EM: DRPG_06Victoria_Base
	{
		scope = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		vehicleClass = "DRPG_Police";
		displayName = "2006 Ford Crown Victoria EMS";
